...
def validate_input_payload(payload: Mapping[str, Any]) -> CanonicalInput:
    ...
    birth_day = _parse_int("birth_day", payload.get("birth_day"))
    birth_month = _parse_int("birth_month", payload.get("birth_month"))
    birth_year = _parse_int("birth_year", payload.get("birth_year"))
    report_year = _parse_int("report_year", payload.get("report_year"))
    ...
    validate_positive_int("birth_year", birth_year)
    validate_positive_int("report_year", report_year)
    try:
    ...
    return CanonicalInput(
        ...
        teacher_full_name=_normalize_text("teacher_full_name", payload.get("teacher_full_name")),
...
def canonical_input_document(raw_input: CanonicalInput) -> dict[str, Any]:
    return {
        ...
        "birth_day": raw_input.birth_day,
        "birth_month": raw_input.birth_month,
        "birth_year": raw_input.birth_year,
