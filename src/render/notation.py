...
def notation_items(section_id: str, derived: dict[str, Any]) -> list[str]:
    ...
    if section_id == "1.3":
        return [
            ...
            "P_wait — вероятность того, что поступившая заявка застала все n операторов занятыми.",
    ...
    return [
        ...
        "M_зан и K_загр — среднее число занятых наладчиков и коэффициент их занятости.",
    ]
