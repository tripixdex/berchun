...
## Objective
Провести полную сквозную проверку `docs/METHODICAL_GUIDE.md` против frozen skeleton, frozen artifact map, current machine-readable outputs, current formal report surface и уже встроенных defense cards, а при необходимости внести только узкие consistency-corrections.
...
- `sed -n '1,220p' docs/METHODICAL_GUIDE_CONTRACT.md`
...
- `sed -n '1,320p' docs/METHODICAL_GUIDE.md`
- `sed -n '321,700p' docs/METHODICAL_GUIDE.md`
- `sed -n '701,1120p' docs/METHODICAL_GUIDE.md`
...
- `rg -n 'первый черновик|stable baseline|черновик' docs/METHODICAL_GUIDE.md docs/METHODICAL_GUIDE_PLAN.md reports/report_M2_methodical_generation.md reports/report_M3_defense_layer.md`
...
- В каждом required subsection сохранён frozen order обязательных блоков из `docs/METHODICAL_GUIDE_SKELETON.md`.
...
- Все числовые токены в `docs/METHODICAL_GUIDE.md` повторно проверены против current artifacts и их допустимых rounded renderings.
...
- В `docs/METHODICAL_GUIDE.md` исправлена одна узкая wording inconsistency в шапке:
...
- Зафиксировать methodical branch как stable baseline на уровне текущего `docs/METHODICAL_GUIDE.md`.
